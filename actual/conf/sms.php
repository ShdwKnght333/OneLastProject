...
$url = "http://203.129.203.243/blank/sms/user/urlsms.php?username=foodzoned&pass=88888&senderid=FZONED&dest_mobileno=" . $PhNo . "&msgtype=TXT&message=" . $Text ."&response=Y";
...
$smstext2 .= "We have received your order #" . $nop['id'] . " amounting to " . setprice($nop['order_total']) . " and it will be delivered soon. Queries! Reach us at 9035515321.\n\n";
...
$url = "http://203.129.203.243/blank/sms/user/urlsms.php?username=foodzoned&pass=88888&senderid=FZONED&dest_mobileno=" . $PhNo . "&msgtype=TXT&message=" . $Text2 ."&response=Y";
