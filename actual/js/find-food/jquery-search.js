    $(document).ready(function(){
        /*
         ...
         in the table.
        */
        $('#results').html('<p style="padding:5px;"><br/> &nbsp; Enter product name to start search.</p><br/>');
...
$.get('js/find-food/search-data.php?' + 'scity=' + encodeURIComponent($("#searchCity").val()) + '&searchData='+searchVal, function(returnData) {
                    ...
                    if (!returnData) {
                        $('#results').html('<p style="padding:5px;"><br/>Search term entered does not return any data.</p>');
                    } else {
