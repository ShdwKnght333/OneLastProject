			...
			<div class="container pageTitle">
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<h2 class="page-title">Fz Wallet FAQ</h2>
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
			</div> <!-- /.container -->
...
<section class="cd-faq">
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Basics are the categories</h2></li>
			<li>
				<a class="cd-faq-trigger" href="#0">Your title over here</a>
				<div class="cd-faq-content">
					<p>your content over here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!</p>
				</div> <!-- cd-faq-content -->
			</li>
