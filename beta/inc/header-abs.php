<div class="responsive_menu">
		...
		<?php	}else {?>
		<li><a onclick="document.getElementById('id01').style.display='block'" style="cursor:pointer;">Login/Signup</a></li>
		<?php } ?>
        </ul> <!-- /.main_menu -->
    </div> <!-- /.responsive_menu -->

	<header class="site-headerpos clearfix">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="main-navigation pull-right">
						<nav class="main-nav visible-md visible-lg">
							...
							<?php if (isset($_SESSION['memberid'])&& $_SESSION['memberid']) { ?>
								...
								<?php	}else {?>
								<li><a style="text-decoration:none;" role="button" class="buttonlog button4" onclick="document.getElementById('id01').style.display='block'">Login/Signup</a></li>
									<?php } ?>
							</ul> <!-- /.sf-menu -->
						</nav> <!-- /.main-nav -->
